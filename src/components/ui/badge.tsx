...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold motion-cinema focus-ring-canonical",
  {
    variants: {
      variant: {
        ...
        outline: "border-border/60 text-foreground bg-card/40 backdrop-blur-glass",
      },
    },
    defaultVariants: {
      variant: "default",
