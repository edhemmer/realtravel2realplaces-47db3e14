        ...
        <DayPicker
          ...
          classNames={{
            ...
            nav_button: cn(
              ...
              "h-7 w-7 bg-transparent p-0 opacity-60 hover:opacity-100 rounded-lg",
            ),
            ...
            day: cn(buttonVariants({ variant: "ghost" }), "h-9 w-9 p-0 font-normal rounded-lg aria-selected:opacity-100"),
            day_range_end: "day-range-end",
            day_selected:
              "bg-primary text-primary-foreground shadow-elevation-floating hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
