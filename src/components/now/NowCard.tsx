              ...
              <div className="flex gap-2">
                {card.primary && (
                  <Button
                    ...
                    className="flex-1 h-11 rounded-xl text-sm font-semibold bg-primary hover:bg-primary/90 text-primary-foreground shadow-sm active:scale-[0.98] transition-transform"
                  >
                    {card.primary.label}
                  </Button>
                )}
                {card.secondary && (
                  <Button
                    ...
                    variant="outline"
                    className="h-11 rounded-xl text-sm font-semibold active:scale-[0.98] transition-transform"
                  >
